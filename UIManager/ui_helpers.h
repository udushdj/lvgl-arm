/**
 * @file ui_helpers.h
 * @brief SquareLine Studio 自动生成的辅助函数声明
 *
 * 包含属性设置封装、动画回调、键盘管理、屏幕切换等辅助函数。
 * 由 SquareLine Studio 1.4.2 生成，LVGL 8.3.11。
 * 补充了手动修改: _ui_screen_change / _ui_screen_delete / 事件回调声明。
 */

#ifndef _UI1_UI_HELPERS_H
#define _UI1_UI_HELPERS_H
